...
{
    // test the direction of the lightDirection 
    ...
    specular = saturate(specular - float4(specularRdown, specularGdown, specularBdown, specularAdown));
    specular = specular + float4(specularRup, specularGup, specularBup, specularAup);
    float3x3 ramp =
    {
